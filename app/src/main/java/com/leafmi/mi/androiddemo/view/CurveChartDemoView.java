...
import com.leafmi.mi.androiddemo.utils.Utils;
 ...
 */
public class CurveChartDemoView extends View {
    ...
    public CurveChartDemoView(Context context) {
        super(context);
        init();
    }

    public CurveChartDemoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CurveChartDemoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawXCoordinateText(Canvas canvas) {
        blackPaint.setTextSize(Utils.dp2Px(12));
        if (model == MODEL_WEEK)
            for (int i = 0; i < 7; i++)
    ...
    private void drawYCoordinateNumber(Canvas canvas) {
        ...
        blackPaint.setTextSize(Utils.dp2Px(10));
        for (int i = 0; i < 10; i++)
